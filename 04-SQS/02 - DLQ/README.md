...
1. No terminal do IDE criado no cloud9 execute o comando `cd ~/environment/Hackaton-exercises-serverless/04-SQS/02\ -\ DLQ/` para entrar na pasta que fara este exercicio.
